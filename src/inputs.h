...
//The stopping threshold for the search function. Higher numbers will cause the funtion to search for longer
...
//Recieves a input of type from whatever source. Can be blocking or nonblocking depending on agent setup.
